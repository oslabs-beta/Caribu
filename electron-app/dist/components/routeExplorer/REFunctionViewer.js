...
function REFunctionViewer() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ style: caribox_1.default }, { children: [(0, jsx_runtime_1.jsx)("span", Object.assign({ className: 'refv-header' }, { children: "Functions" })), functions || ''] })));
}
