...
module.exports = (req, res, next) => {
    ...
    const expressApp = require(copiedServer + req.body.serverpath.replace(req.body.filepath, ""));
    ...
    class middlewareLL {
        constructor(subRoute) {
            ...
            this.makeMiddlewareChain = (stack) => {
    ...
    fs.writeFileSync(path.join(__dirname, "../process/appTrees/originalAppTree.json"), JSON.stringify(originalAppTree), (error) => {
        if (error)
            throw error;
    });
    next();
...
//# sourceMappingURL=getOriginalExpressAppObj.js.map