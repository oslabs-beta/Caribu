module.exports = (req, res, next) => {
    ...
    fs.writeFileSync(path.join(__dirname, "../process/appTrees/renamedAppTree.json"), JSON.stringify(originalAppTree), (error) => {
        if (error)
            throw error;
    });
    next();
...
//# sourceMappingURL=getRenamedExpressAppObj.js.map