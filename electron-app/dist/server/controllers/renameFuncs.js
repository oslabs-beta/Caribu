module.exports = (req, res, next) => {
    ...
    const { _default: arrowToNamed } = require("./plugins/arrowToNamed");
    const { _default: declarationToNewDeclaration, } = require("./plugins/declarationToNewDeclaration");
    const { _default: expressionToDeclaration, } = require("./plugins/expressionToDeclaration");
    // babel modules
