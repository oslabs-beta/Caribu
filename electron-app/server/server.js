...
//   next();
// };
app.post("/routes", copyServer, renameFuncs, getOriginalExpressAppObj, getRenamedExpressAppObj, function (req, res) {
...
app.listen(PORT, function (err) {
    if (err)
        ...
        console.log("Listening to port in server: ".concat(PORT));
});
