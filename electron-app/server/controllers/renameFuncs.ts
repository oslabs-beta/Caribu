module.exports = (req, res, next) => {
  ...
  const {
    _default: declarationToNewDeclaration,
  } = require("./plugins/declarationToNewDeclaration");
  const {
    _default: expressionToDeclaration,
  } = require("./plugins/expressionToDeclaration");
