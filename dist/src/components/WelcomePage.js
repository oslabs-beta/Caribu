...
const WelcomePage = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "welcomePage" }, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ className: "wp-header" }, { children: "Welcome To Caribu" })), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "wp-instructions" }, { children: ["To get started, drop the server folder for your application into the dropzone, then simply specify the absolute paths to your server file and node modules folder, and submit!", " "] })), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(DragDrop_1.default, {}), (0, jsx_runtime_1.jsxs)("form", Object.assign({ className: "form-wrapper" }, { children: [(0, jsx_runtime_1.jsx)("input", { className: "serverName-wrapper", type: "text", placeholder: "Enter server path here", onChange: (e) => __awaiter(void 0, void 0, void 0, function* () {
                                    yield dispatch((0, viewsSlice_1.update_serverpath)({ path: e.target.value }));
                                }) }), (0, jsx_runtime_1.jsx)("input", { className: "nodePath-wrapper", type: "text", placeholder: "Enter node modules path here", onChange: (e) => __awaiter(void 0, void 0, void 0, function* () {
